...
## How to Size This for Your Own Brand
 ...
 Minutes per order spent on entry, correction, and status questions, multiplied by orders per year.

- Your return and chargeback rate on orders that were manually keyed, compared to any that were not.

- Customer service hours spent answering questions about inventory and order status.

- Reorder frequency for your smallest third of accounts, compared to your largest third.
