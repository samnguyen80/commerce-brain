...
## The mistake is treating this as a platform decision 
...
## You are already running more than one connection, it's called EDI 
...
## Your ERP already makes this possible 
 ...
 EDI keeps handling the accounts EDI was built for. RepSpark handles the accounts EDI will never reach.

 Nobody rips anything out. Nordstrom keeps buying the way Nordstrom buys.

## Your reps are already running two motions 
...
## The retailers you want are already on RepSpark 
