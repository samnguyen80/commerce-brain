...
category: "B2B2C"
url: "https://nfx.com/post/network-effects-bible"
title: "The Network Effects Bible"
date: "2026-07-31T21:55:07.234Z"
fetched: "2026-08-29T13:49:30.443Z"
via: "http-discover"
---

The Network Effects Bible 
- Get our weekly newsletter that 322K+ startup teams read
 

 The Network Effects Bible (Updated 2024)
 The NFX Team · @NFX · Jul 2019 
 ...
 The NFX Manual , which describes the 16 different types of network effects
...
## Directionality
 ...
 On a Personal Network like Twitter, for example, well-known people like celebrities and politicians have huge followings which they don’t reciprocate. The flow of information is mostly one way — from the bigger, more central nodes to the smaller, more marginal nodes.

 Contrast that with a Personal Utility Network like Facebook Messenger or WhatsApp, where connections are necessarily reciprocal. If you have a conversation with someone on Facebook Messenger, the flow of information and interaction is bidirectional. So Facebook Messenger and WhatsApp are examples of networks with undirected connections.
...
## Cross-Side Network Effects
 ...
 So to take the example of Uber yet again: there are large positive cross-side network effects because each additional driver adds direct value to all the users on the passenger side ( up to a point ) and vice versa.
...
## Embedding
 ...
 Subscribe for more Network Effects insights
 Get our weekly newsletter that 322K+ startup teams read
